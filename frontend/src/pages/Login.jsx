  ...
  return (
    <section className="mx-auto max-w-md rounded-3xl bg-white p-8 shadow-sm">
      ...
      <p className="mt-6 text-sm text-slate-600">
        Chưa có tài khoản? <Link to="/register" className="text-sky-600">Đăng ký</Link>
      </p>
    </section>
  );
}

// curl -X POST http://localhost:5000/api/auth/login -H "Content-Type: application/json" -d '{"email":"you@example.com","password":"123456"}'
